...
{
    using float_t = multiprecision::cpp_dec_float_50;
    ...
    std::cout
        << "Balance:      "
        << std::setprecision(18) << float_t(to_int(balance)) / float_t("1e18")
        << " ETH\n";
    ...
    std::cout
        << "Gas price:    "
        << std::setprecision(3) << float_t(to_int(gas_price)) / float_t("1e10")
        << " GWEI\n";
